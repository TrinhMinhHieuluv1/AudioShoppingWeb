...
public class DeleteCartItem extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ShoppingCartItem item  = new ShoppingCartItem(pdao.selectAProductByID(Integer.parseInt(product_ID_raw)), 0);
        scdao.deleteItemByUsernameAndProduct_ID((User)session.getAttribute("account"), item);
